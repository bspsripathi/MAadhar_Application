...
public class RegistrationTest {
	...
	public void performTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("Sripathi@gmail.com");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Sri@123");
		driver.findElement(By.xpath("//input[@type='number']")).sendKeys("12345");
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("vishnu");
		driver.findElement(By.cssSelector(".form-group:nth-child(5) > .ng-untouched")).sendKeys("kb Colony");
		driver.findElement(By.cssSelector(".form-group:nth-child(6) > .ng-untouched")).sendKeys("1234567890");
		driver.findElement(By.xpath("//div[7]/input")).sendKeys("23/06/1994");
